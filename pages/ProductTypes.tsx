  ...
  const categories = [
    {
      id: 'c1',
      title: '商业化稳转细胞系',
      description: '提供超过 1,000 个独特靶点的功能性稳转细胞系，覆盖 GPCR、激酶、离子通道及免疫检查点，具有卓越的遗传稳定性。',
    ...
    },
    {
      ...
      description: '即用型检测试剂盒，包含预包装冷冻细胞及配套试剂。解冻即用，24-48 小时内获得高质量实验结果。',
    ...
    },
    {
      id: 'c4',
      title: '工具箱产品',
      description: '包括克隆载体、逆转录颗粒及亲本细胞株，助力快速构建定制化检测系统。',
    ...
    },
    {
      id: 'c5',
      title: '检测试剂盒',
      description: '高灵敏度的 EFC 底物及化学发光检测试剂盒，及各类功能性分析配套试剂盒。',
    ...
    },
    {
      id: 'c6',
      title: '试剂耗材',
      description: 'AssayComplete™ 细胞培养、解冻、复苏、消化及铺板试剂，确保实验一致性与稳定性。',
    ...
    },
    {
      id: 'c8',
      title: '重组酶类产品',
      description: '高纯度重组激酶、磷酸酶、DNA解旋酶及表观遗传蛋白，高灵敏度激酶活性检测试剂盒，适用于体外生化筛选与动力学研究。',
    ...
    },
    {
      id: 'c9',
      title: 'Calixar 膜蛋白',
      description: '利用专利表面活性剂技术，提取天然构象的膜蛋白，用于蛋白的功能研究。',
