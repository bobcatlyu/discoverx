...
export const locales: Record<Language, SiteLocale> = {
  zh: {
    ...
    navSubItems: {
      ...
      [Page.FunctionalScreening]: '化合物筛选',
    ...
    home: {
      ...
      cards: [
        ...
        { id: 'custom', title: '开发服务 Development Service', description: '了解 Assay 开发、Bioassay 开发、样品检测和功能筛选服务。', imageUrl: '/pic/EDRX-CustomCapabilities_StreamlinedApproach-CustomizedCellLineGeneration-scaled-1.jpg', page: Page.Custom },
    ...
    custom: {
      ...
      cards: [
        ...
        { id: 's4', title: '化合物筛选', description: '基于多种检测平台，提供靶向筛选、表型筛选及先导化合物优化服务。', page: Page.FunctionalScreening },
      ],
    },
    documents: {
      title: '产品资料',
  ...
  ja: {
    ...
    navSubItems: {
      ...
      [Page.FunctionalScreening]: '化合物スクリーニング',
    ...
    meta: {
      ...
      [Page.Custom]: { title: '開発サービス', description: 'Assay開発、Bioassay開発、サンプル測定、機能スクリーニングサービスを紹介します。' },
    ...
    home: {
      ...
      cards: [
        ...
        { id: 'custom', title: '開発サービス', description: 'Assay開発、Bioassay開発、サンプル測定、機能スクリーニングサービスを紹介します。', imageUrl: '/pic/EDRX-CustomCapabilities_StreamlinedApproach-CustomizedCellLineGeneration-scaled-1.jpg', page: Page.Custom },
    ...
    custom: {
      ...
      cards: [
        ...
        { id: 's4', title: '機能スクリーニング', description: '多様な検出プラットフォームを用いて、標的指向スクリーニング、表現型スクリーニング、リード最適化を支援します。', page: Page.FunctionalScreening },
      ],
    },
    documents: {
      title: '製品資料',
  ...
  ko: {
    ...
    navSubItems: {
      ...
      [Page.FunctionalScreening]: '화합물 스크리닝',
    ...
    home: {
      ...
      cards: [
        ...
        { id: 'custom', title: '개발 서비스', description: 'Assay 개발, Bioassay 개발, 샘플 측정, 기능 스크리닝 서비스를 소개합니다.', imageUrl: '/pic/EDRX-CustomCapabilities_StreamlinedApproach-CustomizedCellLineGeneration-scaled-1.jpg', page: Page.Custom },
    ...
    custom: {
      ...
      cards: [
        ...
        { id: 's4', title: '화합물 스크리닝', description: '다양한 assay 플랫폼을 기반으로 표적 스크리닝, 표현형 스크리닝, lead optimization을 지원합니다.', page: Page.FunctionalScreening },
      ],
    },
    documents: {
      title: '제품 자료',
